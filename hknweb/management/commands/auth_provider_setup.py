...
class Command(BaseCommand):
    help = 'Update or insert a specific allauth provider entry like Google.'
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument('client_id', type=str, help="Client ID from provider")
        parser.add_argument('client_secret', type=str, help="Secret from provider")
